...
<deegreeOAF xmlns="http://www.deegree.org/ogcapi/features"
  ...
  <AddApiVersionToHeader>true</AddApiVersionToHeader> <!--5-->
...
<5> boolean to configure if `API-Version` should be added in response header or not.
...
<deegreeOAF xmlns="http://www.deegree.org/ogcapi/features"
  ...
  <AddApiVersionToHeader>true</AddApiVersionToHeader> <!--12-->
...
<12> boolean to configure if `API-Version` should be added in response header or not.
